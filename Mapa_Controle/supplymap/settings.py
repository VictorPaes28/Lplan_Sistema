...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'obras.context_processors.obra_context',  # Contexto multi-obra
            ],
        },
    },
]

WSGI_APPLICATION = 'supplymap.wsgi.application'
...
# Para usar Postgres, defina a variável de ambiente DATABASE_URL
# Exemplo: postgresql://user:password@localhost/supplymap
...
# Sessão: mantém login após fechar o navegador
