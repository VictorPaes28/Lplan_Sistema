...
def item_detalhe(request, item_id):
    ...
    pode_excluir = (
        ...
        request.user.groups.filter(name='ENGENHARIA').exists()
    )
    ...
    <div class="detalhe-item">
                ...
                <div class="detalhe-valor"><strong>{item.local_aplicacao.nome if item.local_aplicacao else '⚠️ Não definido'}</strong></div>
    </div>
    <div class="detalhe-item">
