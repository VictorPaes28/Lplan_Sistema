...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_aprovacao', '0012_add_comment_model'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_order', models.ForeignKey(help_text='Pedido relacionado ao lembrete', on_delete=django.db.models.deletion.CASCADE, related_name='lembretes', to='gestao_aprovacao.workorder', verbose_name='Pedido de Obra')),
            ],
            options={
