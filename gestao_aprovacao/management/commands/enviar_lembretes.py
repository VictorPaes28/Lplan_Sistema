...
from gestao_aprovacao.models import WorkOrder, WorkOrderPermission, Empresa, Lembrete, Notificacao
from gestao_aprovacao.utils import criar_notificacao
from gestao_aprovacao.email_utils import enviar_email_novo_pedido
    ...
    def handle(self, *args, **options):
        ...
        for dias in dias_lista:
            ...
            for pedido in pedidos_pendentes:
                ...
                # Buscar aprovadores da empresa da obra (ou da própria obra se sem empresa)
                empresa = pedido.obra.empresa
                if not empresa:
                    obras_empresa = [pedido.obra]
                else:
