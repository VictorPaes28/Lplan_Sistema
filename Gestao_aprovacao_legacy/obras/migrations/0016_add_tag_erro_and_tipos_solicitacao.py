...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('obras', '0015_rename_obras_commen_work_or_idx_obras_comme_work_or_e09554_idx_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='approval',
            name='tags_erro',
            field=models.ManyToManyField(blank=True, help_text='Tags/motivos de erro selecionados para esta reprovação', related_name='approvals', to='obras.tagerro', verbose_name='Tags de Erro'),
        ),
    ]
