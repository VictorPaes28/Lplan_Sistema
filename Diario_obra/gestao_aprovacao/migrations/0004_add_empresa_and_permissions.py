...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('gestao_aprovacao', '0003_make_fields_required'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usuarios_vinculados', to='gestao_aprovacao.empresa', verbose_name='Empresa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('obra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='permissoes', to='gestao_aprovacao.obra', verbose_name='Obra')),
        ...
        migrations.AddIndex(
            model_name='empresa',
            index=models.Index(fields=['codigo'], name='gestao_aprovacao_empre_codigo_idx'),
        ),
        migrations.AddIndex(
            model_name='empresa',
            index=models.Index(fields=['nome'], name='gestao_aprovacao_empre_nome_idx'),
        ),
        migrations.AddIndex(
            model_name='workorderpermission',
            index=models.Index(fields=['obra', 'usuario'], name='gestao_aprovacao_worko_obra_id_usuari_idx'),
        ),
        migrations.AddIndex(
            model_name='workorderpermission',
            index=models.Index(fields=['tipo_permissao', 'ativo'], name='gestao_aprovacao_worko_tipo_pe_ativ_idx'),
        ),
