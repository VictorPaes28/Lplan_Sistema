...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_aprovacao', '0011_add_motivo_exclusao'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_order', models.ForeignKey(help_text='Pedido de obra relacionado', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='gestao_aprovacao.workorder', verbose_name='Pedido de Obra')),
            ],
            options={
