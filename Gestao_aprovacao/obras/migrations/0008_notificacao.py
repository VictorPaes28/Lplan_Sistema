    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_order', models.ForeignKey(blank=True, help_text='Pedido relacionado à notificação (se aplicável)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notificacoes', to='obras.workorder', verbose_name='Pedido Relacionado')),
            ],
            options={
