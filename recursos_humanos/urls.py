...
urlpatterns = [
    ...
    path('colaboradores/<int:pk>/solicitar-pendencias/', views.colaborador_solicitar_pendencias_view, name='colaborador_solicitar_pendencias'),
    path('colaboradores/<int:pk>/solicitar-correcao-dados/', views.colaborador_solicitar_correcao_dados_view, name='colaborador_solicitar_correcao_dados'),
    ...
    path('alertas/exportar-prazos/', views.alertas_export_prazos_view, name='alertas_export_prazos'),
    path('alertas/exportar-experiencia/', views.alertas_export_experiencia_view, name='alertas_export_experiencia'),
    ...
    path('documentos/preview/', views.documentos_config_preview_view, name='documentos_config_preview'),
