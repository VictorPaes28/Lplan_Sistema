    ...
    class Meta:
        ...
        widgets = {
            ...
            'accidents': forms.Textarea(attrs={
                'rows': 2,
                'class': 'diary-extra-field__textarea',
                'placeholder': 'Descreva acidentes, se houver...',
                'data-extra-field': 'accidents',
            }),
            'stoppages': forms.Textarea(attrs={
                'rows': 2,
                'class': 'diary-extra-field__textarea',
                'placeholder': 'Paralisações, interrupções ou paradas...',
                'data-extra-field': 'stoppages',
            }),
            'imminent_risks': forms.Textarea(attrs={
                'rows': 2,
                'class': 'diary-extra-field__textarea',
                'placeholder': 'Riscos identificados no canteiro...',
                'data-extra-field': 'imminent_risks',
            }),
            'incidents': forms.Textarea(attrs={
                'rows': 2,
                'class': 'diary-extra-field__textarea',
                'placeholder': 'Outros eventos relevantes do dia...',
                'data-extra-field': 'incidents',
            }),
            'inspections': forms.Textarea(attrs={
                'rows': 2,
                'class': 'diary-extra-field__textarea',
                'placeholder': 'Fiscalizações realizadas (órgãos, visitas técnicas)...',
                'data-extra-field': 'inspections',
            }),
            'dds': forms.Textarea(attrs={
                'rows': 2,
                'class': 'diary-extra-field__textarea',
                'placeholder': 'Tema abordado, participantes, local...',
                'data-extra-field': 'dds',
            }),
            'general_notes': forms.Textarea(attrs={
                'rows': 3,
                'class': 'diary-extra-field__textarea diary-extra-field__textarea--notes',
                'placeholder': 'Comentários gerais, pendências ou contexto do dia...',
                'data-extra-field': 'general_notes',
            }),
        }
