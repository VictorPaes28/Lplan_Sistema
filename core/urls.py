...
from .frontend_views import (
    ...
    calendar_day_fronts_summary_view,
    report_list_view,
    ...
    notification_open_redirect_view,
...
urlpatterns = [
    ...
    path('support/', support_hub_view, name='support-home'),
    ...
    path('calendar-day-fronts-summary/', calendar_day_fronts_summary_view, name='calendar-day-fronts-summary'),
    ...
    path('notifications/<int:pk>/open/', notification_open_redirect_view, name='notification-open'),
