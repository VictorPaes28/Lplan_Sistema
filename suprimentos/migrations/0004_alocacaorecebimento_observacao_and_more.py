...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(help_text='Local para onde foi alocado', on_delete=django.db.models.deletion.PROTECT, related_name='alocacoes', to='mapa_obras.localobra'),
        ),
        migrations.AlterField(
            model_name='alocacaorecebimento',
        ...
        migrations.AlterField(
            model_name='itemmapa',
            name='local_aplicacao',
            field=models.ForeignKey(blank=True, help_text='LOCAL onde será aplicado (Bloco A, Lobby, etc)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='itens_mapa', to='mapa_obras.localobra'),
        ),
        migrations.AlterField(
            model_name='itemmapa',
            name='nao_aplica',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recebimentos', to='mapa_obras.obra')),
            ],
            options={
